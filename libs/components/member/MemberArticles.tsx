...
import { inputAdornmentClasses, Pagination, Stack, Typography } from '@mui/material';
...
import { sweetMixinErrorAlert, sweetMixinSuccessAlert, sweetTopSmallSuccessAlert } from '../../sweetAlert';
